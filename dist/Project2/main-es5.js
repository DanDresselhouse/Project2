(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArtistoptionspageComponent = /** @class */ (function () {
                function ArtistoptionspageComponent(idTransfer) {
                    this.idTransfer = idTransfer;
                    this.id = 0;
                }
                ArtistoptionspageComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.idTransfer.currentMessage.subscribe(function (id) { return _this.id = id; });
                    console.log(this.id);
                };
                return ArtistoptionspageComponent;
            }());
            ArtistoptionspageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateaccountpageComponent = /** @class */ (function () {
                function CreateaccountpageComponent(postrequest, router) {
                ...
                CreateaccountpageComponent.prototype.checkname = function () {
                    if (this.name === "") {
                        this.nameflag = true;
                    }
                };
                CreateaccountpageComponent.prototype.ngOnInit = function () {
                };
                CreateaccountpageComponent.prototype.createaccount = function () {
                    var _this = this;
                    var body = {
                        id: 0,
                        name: this.name,
                    ...
                    if (this.name === "") {
                        ...
                        if (this.confirmpassword != this.password) {
                            ...
                            console.log(url);
                            this.postrequest.postmethod(url, body).then(function () {
                                console.log("success");
                                if (_this.isartist) {
                            ...
                            }).catch(function (response) { console.log("Information couldn't be found"); });
                        }
                    }
                };
                return CreateaccountpageComponent;
            }());
            CreateaccountpageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginaristpageComponent = /** @class */ (function () {
                function LoginaristpageComponent(postrequest, router, idService) {
                    this.postrequest = postrequest;
                    this.router = router;
                ...
                LoginaristpageComponent.prototype.ngOnInit = function () {
                };
                //this logins the artist and sets the artist object
                LoginaristpageComponent.prototype.login = function () {
                    var _this = this;
                    var body = {
                        id: 0,
                        username: this.username,
                    ...
                    //backend endpoint goes here
                    var url = "http://ec2-18-216-221-127.us-east-2.compute.amazonaws.com:9999/artist/login";
                    this.postrequest.postmethod(url, body).then(function (info) {
                        console.log(info);
                        _this.artistID = info.artistID;
                        _this.idService.changeMessage(_this.artistID);
                        _this.router.navigateByUrl("/artistoptionspage");
                    }).catch(function (response) { console.log("Information couldn't be found"); });
                };
                return LoginaristpageComponent;
            }());
            LoginaristpageComponent.ctorParameters = function () { return [
                { type: src_services_postrequest_service__WEBPACK_IMPORTED_MODULE_2__["PostrequestService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginpageComponent = /** @class */ (function () {
                function LoginpageComponent(postrequest, router) {
                    this.postrequest = postrequest;
                    this.router = router;
                    this.username = "";
                    this.password = "";
                ...
                LoginpageComponent.prototype.login = function () {
                    ...
                    //backend endpoint goes here
                    var url = "http://ec2-18-216-221-127.us-east-2.compute.amazonaws.com:9999/user/login";
                    this.postrequest.postmethod(url, body).then(function () {
                        console.log("success");
                        _this.router.navigateByUrl("/useroptionspage");
                    }).catch(function (response) { console.log("Information couldn't be found"); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UseroptionspageComponent = /** @class */ (function () {
                function UseroptionspageComponent(getrequest) {
                    this.getrequest = getrequest;
                    this.searchinput = "";
                }
                UseroptionspageComponent.prototype.ngOnInit = function () {
                };
                //this logins the artist and sets the artist object
                UseroptionspageComponent.prototype.search = function () {
                    var _this = this;
                    //backend endpoint goes here
                    var url = "";
                    this.getrequest.getmethod(url).then(function (info) {
                        console.log("success");
                        _this.songs = info;
                    }).catch(function (response) { console.log("Information couldn't be found"); });
                };
                UseroptionspageComponent.prototype.getallartists = function () {
                    var _this = this;
                    var url = "http://ec2-18-216-221-127.us-east-2.compute.amazonaws.com:9999/artist";
                    console.log(url);
                    this.getrequest.getmethod(url).then(function (info) {
                        console.log("success");
                        _this.artists = info;
                ...
                return UseroptionspageComponent;
            }());
            UseroptionspageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DataserviceService = /** @class */ (function () {
                ...
                DataserviceService.prototype.changeMessage = function (artistId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GetrequestService = /** @class */ (function () {
                function GetrequestService(http) {
                    this.http = http;
                }
                GetrequestService.prototype.getmethod = function (url) {
            ...
            GetrequestService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var PostrequestService = /** @class */ (function () {
                function PostrequestService(http) {
                    this.http = http;
                }
                //pass in url and body object
                PostrequestService.prototype.postmethod = function (url, postObject) {
                    //put backend rest point here
                    var response = this.http.post(url, postObject).toPromise();
                    return response;
                };
                return PostrequestService;
            }());
            PostrequestService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
